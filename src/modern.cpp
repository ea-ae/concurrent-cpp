...
Modern::Container::Container(size_t size) : data(std::make_unique<int32_t[]>(size)), size(size) {}
...
Modern::Container::Container(const Container& other) : data(std::make_unique<int32_t[]>(other.size)), size(other.size) {
